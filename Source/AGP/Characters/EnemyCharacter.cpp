...
void AEnemyCharacter::BeginPlay()
{
	...
	if (EnemyManager)
	{
		EnemyManager->RegisterSpawnedEnemy();
	}

	OnDestroyed.AddDynamic(this, &AEnemyCharacter::OnEnemyDestroyed);
...
void AEnemyCharacter::OnEnemyDestroyed(AActor* DestroyedActor)
{
	if (EnemyManager)
	{
...
void AEnemyCharacter::FindEnemyManager()
{
	...
	if (!EnemyManager)
	{
		UE_LOG(LogTemp, Error, TEXT("EnemyManager not found in the level"));
	}
}
